...
WEATHER_ROWS = [
    ...
    {
        "label": "Rain-3",
        "filename": "rain_v3_lindau_000007_000019.png",
        "box_red":    [0.10, 0.15, 0.25, 0.30],   # ← 左侧行人区域
        "box_yellow": [0.55, 0.25, 0.25, 0.35],   # ← 右侧远景区域
    },
    {
        "label": "Fog-1",
    ...
    {
        "label": "Fog-3",
        "filename": "foggy_frankfurt_000000_003025.png",
        "box_red":    [0.15, 0.20, 0.25, 0.30],   # ← 近景行人/车辆
        "box_yellow": [0.50, 0.15, 0.25, 0.35],   # ← 远景雾化区域
    },
]
...
LOLV1_ROWS = [
    ...
    },
    {
        "label": "Low-4",
        "filename": "547.png",
        "box_red":    [0.15, 0.10, 0.25, 0.35],   # ← 主体物体区域
        "box_yellow": [0.55, 0.20, 0.25, 0.35],   # ← 暗部细节区域
    },
    {
        "label": "Low-5",
        "filename": "111.png",
        "box_red":    [0.08, 0.15, 0.25, 0.30],   # ← 前景纹理区域
        "box_yellow": [0.50, 0.30, 0.30, 0.30],   # ← 背景色彩区域
    },
]
